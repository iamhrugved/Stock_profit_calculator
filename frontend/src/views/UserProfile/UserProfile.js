...
export default class UserProfile extends React.Component {
  ...
  handleOnSubmit = async (e) => {
    ...
    const result = (await axios.post('http://127.0.0.1:5000/calculateprofit', { amount: this.state.amount, strategies: this.state.strategyOne + (this.state.strategyTwo !== 'DEFAULT' ? ',' + this.state.strategyTwo : '') })).data.result
